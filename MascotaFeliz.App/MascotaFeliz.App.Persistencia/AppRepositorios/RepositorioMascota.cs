       ...
       public IEnumerable<Mascota> GetAllMascotas()
        ...
        public IEnumerable<Mascota> GetMascotasPorFiltro(string filtro)
        {
            ...
            if (mascotas != null)  //Si se tienen saludos
            {
                ...
                {
                    mascotas = mascotas.Where(s => compareInfo.IndexOf((s.Nombre), filtro, CompareOptions.IgnoreNonSpace | CompareOptions.IgnoreCase) > -1);
                }
            }
            return mascotas;
        }

        public IEnumerable<Mascota> GetMascotasPorDueno(string filtro, IEnumerable<Mascota> mascotas)
        {
            //var mascotas = GetAllMascotas(); // Obtiene todos los saludos
            var compareInfo = CultureInfo.InvariantCulture.CompareInfo;
            if (mascotas != null)  //Si se tienen saludos
        ...
        public IEnumerable<Mascota> GetMascotasPorVeterinario(string filtro, IEnumerable<Mascota> mascotas)
        {
            //var mascotas = GetAllMascotas(); // Obtiene todos los saludos
            var compareInfo = CultureInfo.InvariantCulture.CompareInfo;
            if (mascotas != null)  //Si se tienen saludos
